...
sap.ui.define([
	...
	return BaseController.extend("com.agent.controller.Detail", {
		...
		onListUpdateFinished: function(oEvent) {
			...
			//MessageToast.show(oView.byId("test"));
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("TenderShipperSet", {
					Tknum: sObjectId
				});
		...
		onAccept: function(oEvent) {
			var oView = this.getView(),
				...
				item = oList.getSelectedItem();

			if (!oList.getSelectedItem()) {
				alert("Pick a fwd agent");
				return;
			}

			var context = item.getBindingContext(),
				obj = context.getProperty(null, context),
				oUri = "/TenderShipperAgentSet(Tknum='" + obj.Tknum + "',Lifnr='" + obj.Lifnr + "')";

			// update request
			oModel.update(oUri, obj, null, function() {
				MessageToast.show("Update successful");
			}, function() {
				MessageToast.alert("Update failed");
			});
		...
		onEnd: function(oEvent) {
			var oView = this.getView(),
				...
				oObject = oView.getModel().getObject(sPath),
				oModel = oView.getModel(),
				oUri = "/TenderShipperSet('" + oObject.Tknum + "')";
		...
		onCreateTender: function(oEvent) {
			var oView = this.getView(),
				oElementBinding = oView.getElementBinding(),
				sPath = oElementBinding.getPath(),
				oObject = oView.getModel().getObject(sPath),
		...
		assignValidation: function() {
			...
			if (oList.getSelectedItem() && oObject.Tndrst !== "CF") {
			...
			this.byId("assign").setEnabled(bool);
		},
		...
		initWorkflowNotifyWebsocket: function() {
			...
			webSocketURI = socketHostURI + "/sap/bc/apc/sap/zapc_tender_notify";
