sap.ui.define([
		...
		return BaseObject.extend("com.agent.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.agent.model.ListSelector
			 */
			 ...
			 * @return {com.agent.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
