/*global history */
sap.ui.define([
	"com/agent/controller/BaseController",
	...
	return BaseController.extend("com.agent.controller.Master", {
		...
		getWsConnection: function(oModel) {
			...
			//this.oWs = new sap.ui.core.ws.SapPcpWebSocket("/sap/bc/apc/sap/zapc_echo", sap.ui.core.ws.SapPcpWebSocket.SUPPORTED_PROTOCOLS.v10);
			this.oWs = new sap.ui.core.ws.SapPcpWebSocket("/sap/bc/apc/sap/z_tender_push", sap.ui.core.ws.SapPcpWebSocket.SUPPORTED_PROTOCOLS.v10);
		...
		initWorkflowNotifyWebsocket: function() {
			...
			webSocketURI = socketHostURI + "/sap/bc/apc/sap/z_tender_push";*/
			//webSocketURI = socketHostURI + "/sap/bc/apc/sap/zapc_wf_notify";

			//webSocketURI = "ws://ec2-52-57-158-173.eu-central-1.compute.amazonaws.com:50001/sap/bc/apc/sap/z_tender_push";
			webSocketURI = "ws://ec2-52-57-158-173.eu-central-1.compute.amazonaws.com:50001/sap/bc/apc/sap/apc_simple_test";
			

			//sap.m.MessageToast.show("Before websocket!");
			try {
				...
				socket.onmessage = function(wfNotify) {
					sap.m.MessageToast.show("Websocket message!");
				...
				//sap.m.MessageToast.show("Error websocket!");
			}
		},
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("Tknum");
